...
---
Najspoľahlivejší spôsob, akým môže človek zabrániť nákaze [pohlavne prenosnou infekciou (PPI)](/pohlavne-prenosne-infekcie/){:target="_blank"}, je úplná sexuálna abstinencia. Okrem niektorých špecifických prípadov ako nákaza používaním spoločných hygienických potrieb, zdieľaním striekačiek a podobne, je prakticky nemožné nakaziť sa PPI v prípade, že sa človek nezapája do sexuálnych aktivít vôbec. Zásady, akými môžu znížiť riziko prenosu PPI ľudia, ktorí chcú byť sexuálne aktívni, sa dajú zhrnúť pod KTO: [komunikácia](/komunikacia-v-sexualnom-vztahu/){:target="_blank"}, testovanie, [ochrana + očkovanie](/ako-sa-chranit-proti-nezelanemu-tehotenstvu-a-prenosu-ppi/){:target="_blank"} (na HPV, hepatitídu typu B). 
